...
SCPN Muon Fusion Core — GOVERNANCE
-->
...
The project boundary — the assignment of
`scpn.reactor_systems:muon_catalysed_fusion` to this repository, and the exclusions listed in the
