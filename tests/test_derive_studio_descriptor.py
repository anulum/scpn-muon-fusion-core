...
# SCPN Muon Fusion Core — Studio descriptor derivation tests
...
def test_descriptor_projects_identity_without_authority() -> None:
    ...
    assert descriptor["project"] == "SCPN-MUON-FUSION-CORE"
    assert descriptor["configurations"] == [
        "scpn.reactor_systems:muon_catalysed_fusion",
    ]
    assert descriptor["capabilities"] == []
    assert descriptor["evidence_maturity"] == "architecture_only"
